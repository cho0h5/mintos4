...
#define GDT_TYPE_DATA               0x0a
#define GDT_TYPE_TSS                0x0a
#define GDT_FLAGS_LOWER_S           0x0a
#define GDT_FLAGS_LOWER_DPL0        0x0a
#define GDT_FLAGS_LOWER_DPL1        0x0a
#define GDT_FLAGS_LOWER_DPL2        0x0a
#define GDT_FLAGS_LOWER_DPL3        0x0a
#define GDT_FLAGS_LOWER_P           0x0a
#define GDT_FLAGS_UPPER_L           0x0a
#define GDT_FLAGS_UPPER_DB          0x0a
#define GDT_FLAGS_UPPER_G           0x0a
